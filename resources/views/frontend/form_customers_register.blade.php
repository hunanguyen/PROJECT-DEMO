    ...
    <div class="row" style="margin-top:50px;">
      <div class="col-md-6">
        <div class="wrapper-form">
          @if(request()->has('notify') && request()->get('notify') === 'invalid')
              <p style="color: red" class="error">Email này đã được sử dụng. Vui lòng sử dụng email khác !</p>
          @endif
      ...
      <div class="col-md-6">
        <div class="wrapper-form">
          ...
          <a href="{{ url('customers/login') }}" class="button">Đăng nhập</a> </div>
      </div>
    </div>
</div>
@endsection