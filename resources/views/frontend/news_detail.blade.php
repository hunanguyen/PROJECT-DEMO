...
@php
	function getNewsName($id){
		$name = DB::table("news")->where("id","=",$id)->select("name")->first();
    ...
    <div class="container">
        <div class="menu-bar">
            <ul>
                ...
                <li>
                <span><i class="fa-solid fa-chevron-right"></i></span>
                    <a href="#" style="color: #eb3e32">{{ getNewsName($record->id)}}</a>
                </li>
        ...
        <!-- tintuc1 -->
            ...
            <div class="row">
                ...
                <div class="blog-infor">
                    <h2 class="blog-name"><a href="">{{ $record->name }}</a></h2>
                    <div class="date">
                        @php
                    ...
                    <div class="time">{{ date("d/m/Y", strtotime($record->date)) }}</div>
                    <div class="count-blog">
                            <i class="fa-solid fa-user"></i> Đăng bởi admin
                    </div>
                    </div>
                    <div class="sumary">{!! $record->content !!}</div>
                    <div class="sumary">{!! $record->description !!}</div>
                </div>
            </div>
